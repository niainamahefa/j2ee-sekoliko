...
public class ProfesseurServlet extends HttpServlet {
			...
			throws SQLException, IOException 
	{
		...
		Professeur professeur = new Professeur(prof_nom, prof_prenom,cls_nom, mat_nom);
			...
			throws  SQLException, IOException
	{
		...
		Professeur professeur = new Professeur(prof_id,prof_nom, prof_prenom,cls_nom, mat_nom);
