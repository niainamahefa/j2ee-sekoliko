    	...
    	<div class="card">
    		<div class="card-body">
    		 <div class="container text-right">
    		 	<a href="<%= request.getContextPath()%>/nouveau_matiere" class="btn btn-primary"  ><i class ="fas fa-plus"></i> Hanampy taranja</a>
    		 </div>
    		 <h4 class="text-primary mb-5 font-weight-bold">Lisitry ny taranja </h4>	
    			<table class="table mt-3 " id="table_mat">
                    ...
                    <tbody>
                       <c:forEach var="matiere" items="${listMatiere }">
                            <tr>
                                ...
                                <td> 
                                <a class="btn btn-sm btn-success" href="editer_matiere?mat_id=<c:out value="${matiere.mat_id }"/>" ><i class="fas fa-edit"></i></a>
                                <a class="btn btn-sm btn-danger" href="supprimer_matiere?mat_id=<c:out value="${matiere.mat_id }"/>" ><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                   		</c:forEach>
                    </tbody>
